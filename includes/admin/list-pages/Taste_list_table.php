...
/**
 * 
 * Taste_List_Table from WP_List_Table
...
/**
 * Administration API: Taste_List_Table class
 *
 * @package WordPress
...
class Taste_list_table {
	...
	public function ajax_user_can() {
		die( 'function Taste_List_Table::ajax_user_can() must be overridden in a subclass.' );
	}

	/**
	 * Prepares the list of items for displaying.
	 *
	 * @uses Taste_List_Table::set_pagination_args()
	 *
	 * @since 3.1.0
	 * @abstract
	 */
	public function prepare_items() {
		die( 'function Taste_List_Table::prepare_items() must be overridden in a subclass.' );
	}
...
<p class="search-box">
	...
	public function get_columns() {
		die( 'function Taste_List_Table::get_columns() must be overridden in a subclass.' );
	}
	...
	/**
	 * Public wrapper for Taste_List_Table::get_default_primary_column_name().
	 *
	 * @since 4.4.0
	 *
...
<table class="wp-list-table <?php echo implode( ' ', $this->get_table_classes() ); ?>">
	...
	/**
	 * Gets a list of CSS classes for the Taste_List_Table table tag.
	 *
	 * @since 3.1.0
	 *
	...
	protected function handle_row_actions( $item, $column_name, $primary ) {
		return $column_name === $primary ? '<button type="button" class="toggle-row"></button>' : '';
	}
